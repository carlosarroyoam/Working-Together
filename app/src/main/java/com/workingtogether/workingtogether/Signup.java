...
import com.workingtogether.workingtogether.adapter.SignupSlideAdapter;

public class Signup extends AppCompatActivity {
    private ViewPager view_pager;
    private LinearLayout dots_layout;
    private SignupSlideAdapter signupSlideAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupSlideAdapter = new SignupSlideAdapter(this);
        view_pager.setAdapter(signupSlideAdapter);
