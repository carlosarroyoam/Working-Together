...
public class ContactsRecyclerViewAdapter extends RecyclerView.Adapter<ContactsRecyclerViewAdapter.ViewHolder> {
    ...
    private ContactsRecyclerViewAdapter.RecyclerViewOnItemClickListener mRecyclerViewOnItemClickListener;
    private SparseBooleanArray mSelectedItems;

    public ContactsRecyclerViewAdapter(ContactsRecyclerViewAdapter.RecyclerViewOnItemClickListener mRecyclerViewOnItemClickListener, ArrayList<User> conversationArrayList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (mContactsDataset.get(position).getUSERTYPE().equals(LocalParams.TEACHERUSER))
            holder.mImg.setImageResource(R.drawable.ic_teacher);
        if (mContactsDataset.get(position).getUSERTYPE().equals(LocalParams.PARENTUSER))
