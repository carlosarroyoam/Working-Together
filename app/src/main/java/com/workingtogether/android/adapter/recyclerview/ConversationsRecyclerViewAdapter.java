...
public class ConversationsRecyclerViewAdapter extends RecyclerView.Adapter<ConversationsRecyclerViewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ConversationsRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.mContactName.setText(String.format("%s %s", conversationUser.getFirstName(), conversationUser.getLastName()));
        if (userLogged.getUIDUSER() == conversationUser.getId())
            holder.mLastMessageContent.setText(String.format("Tu: %s", message.getDATA()));
        else
